...
SELECT
    -- Medical
    M.MedicalID, M.StudentRegNo, M.StartDate, M.EndDate, M.SubmittedDate, M.DocumentPath, M.ApprovalStatus,
...
FROM
    ...
    JOIN (
        ...
        FROM Medicals M2
            JOIN Lecture L2 ON L2.LectureDate BETWEEN M2.StartDate AND M2.EndDate
    ) X ON X.MedicalID = M.MedicalID
